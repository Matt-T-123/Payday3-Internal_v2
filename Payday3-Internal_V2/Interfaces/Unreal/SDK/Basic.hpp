...
namespace Offsets
{
	constexpr int32 GObjects          = 0x073CCFE0;
	constexpr int32 AppendString      = 0x01A730B0;
	constexpr int32 GNames            = 0x07375100;
	constexpr int32 GWorld            = 0x07522DE0;
	constexpr int32 ProcessEvent      = 0x01C6EDD0;
